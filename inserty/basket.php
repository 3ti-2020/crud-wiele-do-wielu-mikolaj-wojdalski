...
$sql = "INSERT INTO `insert_tab` (`id_autor`, `Autor`, `Tytul`, `user`,`data_wyp`,`data_oddania`) VALUES (NULL, 'Roland Lazenby', 'Michael Jordan. Życie', RAND()*999, NOW(), NOW()+INTERVAL 1 MONTH)";
